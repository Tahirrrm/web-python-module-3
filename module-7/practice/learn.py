...
# x - создает новый файл, если такой уже существует, то выдаст ошибку
...
# file.write ("- добавили в конец") # вопросительные знаки вместо русских буквбдля решения добавляется кодировка
# file.close()

# file = open("file.txt", "a", encoding ="utf-8")
# file.write("-добавили в конец") # вопросительные знаки вместо русских буквб для решения добавляется кодировка
# file.close()


# f = open ("file1.txt", "a", encoding="utd-8")
# f.write("1,2,3\n")
# f.write("4,5,6\n")
# f.write("7,8,9")
# f.close
